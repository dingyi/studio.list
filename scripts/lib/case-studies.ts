...
const excludedPathPattern =
  /^\/(?:about|contact|teams?|services?|blog|news|journal|articles?|careers?|jobs?|[\w-]*tags?|[\w-]*categor(?:y|ies)|authors?|search|shop|store|feed|rss|press|faq|process|approach|expertise|clients?|privacy[\w-]*|terms[\w-]*|legal[\w-]*|imprint[\w-]*|cookies?[\w-]*)(\/|$)/i;
